...
return {
  ...
  recommended = true,
  {
    ...
    keys = {
      ...
      { "<leader>sc", LazyVim.pick.config_files(), desc = "[S]earch NVIM [C]onfig" },
      ...
      { "<leader>sB", function() Snacks.picker.grep_buffers() end, desc = "[S]earch inside [B]uffers" },
      -- { "<leader>sg", LazyVim.pick("live_grep"), desc = "Grep (Root Dir)" },
      -- { "<leader>sG", LazyVim.pick("live_grep", { root = false }), desc = "Grep (cwd)" },
      -- { "<leader>sp", function() Snacks.picker.lazy() end, desc = "Search for Plugin Spec" },
      { "<leader>sw", LazyVim.pick("grep_word"), desc = "[S]earch for [W]ord (root)", mode = { "n", "x" } },
      { "<leader>sW", LazyVim.pick("grep_word", { root = false }), desc = "[S]earch for [W]ord (cwd)", mode = { "n", "x" } },
      -- search
      ...
      { "<leader>sj", function() Snacks.picker.jumps() end, desc = "[S]earch [J]ump History" },
  ...
  },
  {
    ...
    keys = {
      ...
      { "<leader>sT", function () Snacks.picker.todo_comments({ keywords = { "TODO", "FIX", "FIXME", "NOTE" } }) end, desc = "[S]earch [T]odo/Fix/Fixme/Note" },
      { "<leader>sR", function () Snacks.picker.todo_comments({ keywords = { "REVIEW" } }) end, desc = "[S]earch [R]eview Comments" },
    },
  },
  {
    "folke/snacks.nvim",
